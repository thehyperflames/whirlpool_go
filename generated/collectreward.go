...
// NewCollectRewardInstructionBuilder creates a new `CollectRewardInstruction` instruction builder.
func NewCollectRewardInstructionBuilder() *CollectRewardInstruction {
	nd := &CollectRewardInstruction{
...
func (inst *CollectRewardInstruction) SetRewardIndex(rewardIndex uint8) *CollectRewardInstruction {
	inst.RewardIndex = &rewardIndex
	return inst
}

// SetWhirlpoolAccount sets the "whirlpool" account.
func (inst *CollectRewardInstruction) SetWhirlpoolAccount(whirlpool ag_solanago.PublicKey) *CollectRewardInstruction {
	inst.AccountMetaSlice[0] = ag_solanago.Meta(whirlpool)
	return inst
}

// GetWhirlpoolAccount gets the "whirlpool" account.
func (inst *CollectRewardInstruction) GetWhirlpoolAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetPositionAuthorityAccount sets the "positionAuthority" account.
func (inst *CollectRewardInstruction) SetPositionAuthorityAccount(positionAuthority ag_solanago.PublicKey) *CollectRewardInstruction {
	inst.AccountMetaSlice[1] = ag_solanago.Meta(positionAuthority)
	return inst
}

// GetPositionAuthorityAccount gets the "positionAuthority" account.
func (inst *CollectRewardInstruction) GetPositionAuthorityAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(1)
}

// SetPositionAccount sets the "position" account.
func (inst *CollectRewardInstruction) SetPositionAccount(position ag_solanago.PublicKey) *CollectRewardInstruction {
	inst.AccountMetaSlice[2] = ag_solanago.Meta(position)
	return inst
}

// GetPositionAccount gets the "position" account.
func (inst *CollectRewardInstruction) GetPositionAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(2)
}

// SetPositionTokenAccountAccount sets the "positionTokenAccount" account.
func (inst *CollectRewardInstruction) SetPositionTokenAccountAccount(positionTokenAccount ag_solanago.PublicKey) *CollectRewardInstruction {
...
func (inst *CollectRewardInstruction) GetPositionTokenAccountAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(3)
}

// SetRewardOwnerAccountAccount sets the "rewardOwnerAccount" account.
func (inst *CollectRewardInstruction) SetRewardOwnerAccountAccount(rewardOwnerAccount ag_solanago.PublicKey) *CollectRewardInstruction {
...
func (inst *CollectRewardInstruction) GetRewardOwnerAccountAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(4)
}

// SetRewardVaultAccount sets the "rewardVault" account.
func (inst *CollectRewardInstruction) SetRewardVaultAccount(rewardVault ag_solanago.PublicKey) *CollectRewardInstruction {
	inst.AccountMetaSlice[5] = ag_solanago.Meta(rewardVault)
	return inst
}

// GetRewardVaultAccount gets the "rewardVault" account.
func (inst *CollectRewardInstruction) GetRewardVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(5)
}

// SetTokenProgramAccount sets the "tokenProgram" account.
func (inst *CollectRewardInstruction) SetTokenProgramAccount(tokenProgram ag_solanago.PublicKey) *CollectRewardInstruction {
	inst.AccountMetaSlice[6] = ag_solanago.Meta(tokenProgram)
	return inst
}

// GetTokenProgramAccount gets the "tokenProgram" account.
func (inst *CollectRewardInstruction) GetTokenProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(6)
}

func (inst CollectRewardInstruction) Build() *Instruction {
...
func (inst CollectRewardInstruction) ValidateAndBuild() (*Instruction, error) {
...
func (inst *CollectRewardInstruction) Validate() error {
...
func (inst *CollectRewardInstruction) EncodeToTree(parent ag_treeout.Branches) {
...
func (obj CollectRewardInstruction) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
...
func (obj *CollectRewardInstruction) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
...
func NewCollectRewardInstruction(
	...
	tokenProgram ag_solanago.PublicKey) *CollectRewardInstruction {
