...
// NewSetRewardEmissionsInstructionBuilder creates a new `SetRewardEmissionsInstruction` instruction builder.
func NewSetRewardEmissionsInstructionBuilder() *SetRewardEmissionsInstruction {
	nd := &SetRewardEmissionsInstruction{
...
func (inst *SetRewardEmissionsInstruction) SetRewardIndex(rewardIndex uint8) *SetRewardEmissionsInstruction {
	inst.RewardIndex = &rewardIndex
	return inst
}

// SetEmissionsPerSecondX64 sets the "emissionsPerSecondX64" parameter.
func (inst *SetRewardEmissionsInstruction) SetEmissionsPerSecondX64(emissionsPerSecondX64 ag_binary.Uint128) *SetRewardEmissionsInstruction {
	inst.EmissionsPerSecondX64 = &emissionsPerSecondX64
	return inst
}

// SetWhirlpoolAccount sets the "whirlpool" account.
func (inst *SetRewardEmissionsInstruction) SetWhirlpoolAccount(whirlpool ag_solanago.PublicKey) *SetRewardEmissionsInstruction {
	inst.AccountMetaSlice[0] = ag_solanago.Meta(whirlpool)
	return inst
}

// GetWhirlpoolAccount gets the "whirlpool" account.
func (inst *SetRewardEmissionsInstruction) GetWhirlpoolAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetRewardAuthorityAccount sets the "rewardAuthority" account.
func (inst *SetRewardEmissionsInstruction) SetRewardAuthorityAccount(rewardAuthority ag_solanago.PublicKey) *SetRewardEmissionsInstruction {
	inst.AccountMetaSlice[1] = ag_solanago.Meta(rewardAuthority)
	return inst
}

// GetRewardAuthorityAccount gets the "rewardAuthority" account.
func (inst *SetRewardEmissionsInstruction) GetRewardAuthorityAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(1)
}

// SetRewardVaultAccount sets the "rewardVault" account.
func (inst *SetRewardEmissionsInstruction) SetRewardVaultAccount(rewardVault ag_solanago.PublicKey) *SetRewardEmissionsInstruction {
	inst.AccountMetaSlice[2] = ag_solanago.Meta(rewardVault)
	return inst
}

// GetRewardVaultAccount gets the "rewardVault" account.
func (inst *SetRewardEmissionsInstruction) GetRewardVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(2)
}

func (inst SetRewardEmissionsInstruction) Build() *Instruction {
...
func (inst SetRewardEmissionsInstruction) ValidateAndBuild() (*Instruction, error) {
...
func (inst *SetRewardEmissionsInstruction) Validate() error {
...
func (inst *SetRewardEmissionsInstruction) EncodeToTree(parent ag_treeout.Branches) {
...
func (obj SetRewardEmissionsInstruction) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
...
func (obj *SetRewardEmissionsInstruction) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
...
func NewSetRewardEmissionsInstruction(
	...
	rewardVault ag_solanago.PublicKey) *SetRewardEmissionsInstruction {
