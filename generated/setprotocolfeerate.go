...
// NewSetProtocolFeeRateInstructionBuilder creates a new `SetProtocolFeeRateInstruction` instruction builder.
func NewSetProtocolFeeRateInstructionBuilder() *SetProtocolFeeRateInstruction {
	nd := &SetProtocolFeeRateInstruction{
...
func (inst *SetProtocolFeeRateInstruction) SetProtocolFeeRate(protocolFeeRate uint16) *SetProtocolFeeRateInstruction {
	inst.ProtocolFeeRate = &protocolFeeRate
	return inst
}

// SetWhirlpoolsConfigAccount sets the "whirlpoolsConfig" account.
func (inst *SetProtocolFeeRateInstruction) SetWhirlpoolsConfigAccount(whirlpoolsConfig ag_solanago.PublicKey) *SetProtocolFeeRateInstruction {
	inst.AccountMetaSlice[0] = ag_solanago.Meta(whirlpoolsConfig)
	return inst
}

// GetWhirlpoolsConfigAccount gets the "whirlpoolsConfig" account.
func (inst *SetProtocolFeeRateInstruction) GetWhirlpoolsConfigAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetWhirlpoolAccount sets the "whirlpool" account.
func (inst *SetProtocolFeeRateInstruction) SetWhirlpoolAccount(whirlpool ag_solanago.PublicKey) *SetProtocolFeeRateInstruction {
	inst.AccountMetaSlice[1] = ag_solanago.Meta(whirlpool)
	return inst
}

// GetWhirlpoolAccount gets the "whirlpool" account.
func (inst *SetProtocolFeeRateInstruction) GetWhirlpoolAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(1)
}

// SetFeeAuthorityAccount sets the "feeAuthority" account.
func (inst *SetProtocolFeeRateInstruction) SetFeeAuthorityAccount(feeAuthority ag_solanago.PublicKey) *SetProtocolFeeRateInstruction {
	inst.AccountMetaSlice[2] = ag_solanago.Meta(feeAuthority)
	return inst
}

// GetFeeAuthorityAccount gets the "feeAuthority" account.
func (inst *SetProtocolFeeRateInstruction) GetFeeAuthorityAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(2)
}

func (inst SetProtocolFeeRateInstruction) Build() *Instruction {
...
func (inst SetProtocolFeeRateInstruction) ValidateAndBuild() (*Instruction, error) {
...
func (inst *SetProtocolFeeRateInstruction) Validate() error {
...
func (inst *SetProtocolFeeRateInstruction) EncodeToTree(parent ag_treeout.Branches) {
...
func (obj SetProtocolFeeRateInstruction) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
...
func (obj *SetProtocolFeeRateInstruction) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
...
func NewSetProtocolFeeRateInstruction(
	...
	feeAuthority ag_solanago.PublicKey) *SetProtocolFeeRateInstruction {
