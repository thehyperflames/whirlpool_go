...
type OpenPositionWithMetadataInstruction struct {
	...
	// [3] = [] positionMint
	//
	// [4] = [] positionMetadataAccount
	//
	// [5] = [] positionTokenAccount
	//
	// [6] = [] whirlpool
	//
	// [7] = [] tokenProgram
...
// NewOpenPositionWithMetadataInstructionBuilder creates a new `OpenPositionWithMetadataInstruction` instruction builder.
func NewOpenPositionWithMetadataInstructionBuilder() *OpenPositionWithMetadataInstruction {
	nd := &OpenPositionWithMetadataInstruction{
...
func (inst *OpenPositionWithMetadataInstruction) SetBumps(bumps OpenPositionWithMetadataBumps) *OpenPositionWithMetadataInstruction {
	inst.Bumps = &bumps
	return inst
}

// SetTickLowerIndex sets the "tickLowerIndex" parameter.
func (inst *OpenPositionWithMetadataInstruction) SetTickLowerIndex(tickLowerIndex int32) *OpenPositionWithMetadataInstruction {
	inst.TickLowerIndex = &tickLowerIndex
	return inst
}

// SetTickUpperIndex sets the "tickUpperIndex" parameter.
func (inst *OpenPositionWithMetadataInstruction) SetTickUpperIndex(tickUpperIndex int32) *OpenPositionWithMetadataInstruction {
	inst.TickUpperIndex = &tickUpperIndex
	return inst
}

// SetFunderAccount sets the "funder" account.
func (inst *OpenPositionWithMetadataInstruction) SetFunderAccount(funder ag_solanago.PublicKey) *OpenPositionWithMetadataInstruction {
	inst.AccountMetaSlice[0] = ag_solanago.Meta(funder)
	return inst
}

// GetFunderAccount gets the "funder" account.
func (inst *OpenPositionWithMetadataInstruction) GetFunderAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetOwnerAccount sets the "owner" account.
func (inst *OpenPositionWithMetadataInstruction) SetOwnerAccount(owner ag_solanago.PublicKey) *OpenPositionWithMetadataInstruction {
	inst.AccountMetaSlice[1] = ag_solanago.Meta(owner)
	return inst
}

// GetOwnerAccount gets the "owner" account.
func (inst *OpenPositionWithMetadataInstruction) GetOwnerAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(1)
}

// SetPositionAccount sets the "position" account.
func (inst *OpenPositionWithMetadataInstruction) SetPositionAccount(position ag_solanago.PublicKey) *OpenPositionWithMetadataInstruction {
	inst.AccountMetaSlice[2] = ag_solanago.Meta(position)
	return inst
}

// GetPositionAccount gets the "position" account.
func (inst *OpenPositionWithMetadataInstruction) GetPositionAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(2)
}

// SetPositionMintAccount sets the "positionMint" account.
func (inst *OpenPositionWithMetadataInstruction) SetPositionMintAccount(positionMint ag_solanago.PublicKey) *OpenPositionWithMetadataInstruction {
	inst.AccountMetaSlice[3] = ag_solanago.Meta(positionMint)
	return inst
}

// GetPositionMintAccount gets the "positionMint" account.
func (inst *OpenPositionWithMetadataInstruction) GetPositionMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(3)
}

// SetPositionMetadataAccountAccount sets the "positionMetadataAccount" account.
func (inst *OpenPositionWithMetadataInstruction) SetPositionMetadataAccountAccount(positionMetadataAccount ag_solanago.PublicKey) *OpenPositionWithMetadataInstruction {
	inst.AccountMetaSlice[4] = ag_solanago.Meta(positionMetadataAccount)
	return inst
}

// GetPositionMetadataAccountAccount gets the "positionMetadataAccount" account.
func (inst *OpenPositionWithMetadataInstruction) GetPositionMetadataAccountAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(4)
}

// SetPositionTokenAccountAccount sets the "positionTokenAccount" account.
func (inst *OpenPositionWithMetadataInstruction) SetPositionTokenAccountAccount(positionTokenAccount ag_solanago.PublicKey) *OpenPositionWithMetadataInstruction {
	inst.AccountMetaSlice[5] = ag_solanago.Meta(positionTokenAccount)
	return inst
}

// GetPositionTokenAccountAccount gets the "positionTokenAccount" account.
func (inst *OpenPositionWithMetadataInstruction) GetPositionTokenAccountAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(5)
}

// SetWhirlpoolAccount sets the "whirlpool" account.
func (inst *OpenPositionWithMetadataInstruction) SetWhirlpoolAccount(whirlpool ag_solanago.PublicKey) *OpenPositionWithMetadataInstruction {
	inst.AccountMetaSlice[6] = ag_solanago.Meta(whirlpool)
	return inst
}

// GetWhirlpoolAccount gets the "whirlpool" account.
func (inst *OpenPositionWithMetadataInstruction) GetWhirlpoolAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(6)
}

// SetTokenProgramAccount sets the "tokenProgram" account.
func (inst *OpenPositionWithMetadataInstruction) SetTokenProgramAccount(tokenProgram ag_solanago.PublicKey) *OpenPositionWithMetadataInstruction {
	inst.AccountMetaSlice[7] = ag_solanago.Meta(tokenProgram)
	return inst
}

// GetTokenProgramAccount gets the "tokenProgram" account.
func (inst *OpenPositionWithMetadataInstruction) GetTokenProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(7)
}

// SetSystemProgramAccount sets the "systemProgram" account.
func (inst *OpenPositionWithMetadataInstruction) SetSystemProgramAccount(systemProgram ag_solanago.PublicKey) *OpenPositionWithMetadataInstruction {
	inst.AccountMetaSlice[8] = ag_solanago.Meta(systemProgram)
	return inst
}

// GetSystemProgramAccount gets the "systemProgram" account.
func (inst *OpenPositionWithMetadataInstruction) GetSystemProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(8)
}

// SetRentAccount sets the "rent" account.
func (inst *OpenPositionWithMetadataInstruction) SetRentAccount(rent ag_solanago.PublicKey) *OpenPositionWithMetadataInstruction {
	inst.AccountMetaSlice[9] = ag_solanago.Meta(rent)
	return inst
}

// GetRentAccount gets the "rent" account.
func (inst *OpenPositionWithMetadataInstruction) GetRentAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(9)
}

// SetAssociatedTokenProgramAccount sets the "associatedTokenProgram" account.
func (inst *OpenPositionWithMetadataInstruction) SetAssociatedTokenProgramAccount(associatedTokenProgram ag_solanago.PublicKey) *OpenPositionWithMetadataInstruction {
	inst.AccountMetaSlice[10] = ag_solanago.Meta(associatedTokenProgram)
	return inst
}

// GetAssociatedTokenProgramAccount gets the "associatedTokenProgram" account.
func (inst *OpenPositionWithMetadataInstruction) GetAssociatedTokenProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(10)
}

// SetMetadataProgramAccount sets the "metadataProgram" account.
func (inst *OpenPositionWithMetadataInstruction) SetMetadataProgramAccount(metadataProgram ag_solanago.PublicKey) *OpenPositionWithMetadataInstruction {
	inst.AccountMetaSlice[11] = ag_solanago.Meta(metadataProgram)
	return inst
}

// GetMetadataProgramAccount gets the "metadataProgram" account.
func (inst *OpenPositionWithMetadataInstruction) GetMetadataProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(11)
}

// SetMetadataUpdateAuthAccount sets the "metadataUpdateAuth" account.
func (inst *OpenPositionWithMetadataInstruction) SetMetadataUpdateAuthAccount(metadataUpdateAuth ag_solanago.PublicKey) *OpenPositionWithMetadataInstruction {
...
func (inst *OpenPositionWithMetadataInstruction) GetMetadataUpdateAuthAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(12)
}

func (inst OpenPositionWithMetadataInstruction) Build() *Instruction {
...
func (inst OpenPositionWithMetadataInstruction) ValidateAndBuild() (*Instruction, error) {
...
func (inst *OpenPositionWithMetadataInstruction) Validate() error {
...
func (inst *OpenPositionWithMetadataInstruction) EncodeToTree(parent ag_treeout.Branches) {
...
func (obj OpenPositionWithMetadataInstruction) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
...
func (obj *OpenPositionWithMetadataInstruction) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Deserialize `Bumps`:
...
func NewOpenPositionWithMetadataInstruction(
	...
	metadataUpdateAuth ag_solanago.PublicKey) *OpenPositionWithMetadataInstruction {
