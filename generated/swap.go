...
// NewSwapInstructionBuilder creates a new `SwapInstruction` instruction builder.
...
func (inst *SwapInstruction) SetOtherAmountThreshold(otherAmountThreshold uint64) *SwapInstruction {
	inst.OtherAmountThreshold = &otherAmountThreshold
	return inst
}

// SetSqrtPriceLimit sets the "sqrtPriceLimit" parameter.
func (inst *SwapInstruction) SetSqrtPriceLimit(sqrtPriceLimit ag_binary.Uint128) *SwapInstruction {
	inst.SqrtPriceLimit = &sqrtPriceLimit
	return inst
}

// SetAmountSpecifiedIsInput sets the "amountSpecifiedIsInput" parameter.
func (inst *SwapInstruction) SetAmountSpecifiedIsInput(amountSpecifiedIsInput bool) *SwapInstruction {
	inst.AmountSpecifiedIsInput = &amountSpecifiedIsInput
	return inst
}

// SetAToB sets the "aToB" parameter.
func (inst *SwapInstruction) SetAToB(aToB bool) *SwapInstruction {
	inst.AToB = &aToB
	return inst
}

// SetTokenProgramAccount sets the "tokenProgram" account.
func (inst *SwapInstruction) SetTokenProgramAccount(tokenProgram ag_solanago.PublicKey) *SwapInstruction {
	inst.AccountMetaSlice[0] = ag_solanago.Meta(tokenProgram)
	return inst
}

// GetTokenProgramAccount gets the "tokenProgram" account.
func (inst *SwapInstruction) GetTokenProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetTokenAuthorityAccount sets the "tokenAuthority" account.
func (inst *SwapInstruction) SetTokenAuthorityAccount(tokenAuthority ag_solanago.PublicKey) *SwapInstruction {
	inst.AccountMetaSlice[1] = ag_solanago.Meta(tokenAuthority)
	return inst
}

// GetTokenAuthorityAccount gets the "tokenAuthority" account.
func (inst *SwapInstruction) GetTokenAuthorityAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(1)
}

// SetWhirlpoolAccount sets the "whirlpool" account.
func (inst *SwapInstruction) SetWhirlpoolAccount(whirlpool ag_solanago.PublicKey) *SwapInstruction {
	inst.AccountMetaSlice[2] = ag_solanago.Meta(whirlpool)
	return inst
}

// GetWhirlpoolAccount gets the "whirlpool" account.
func (inst *SwapInstruction) GetWhirlpoolAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(2)
}

// SetTokenOwnerAccountAAccount sets the "tokenOwnerAccountA" account.
func (inst *SwapInstruction) SetTokenOwnerAccountAAccount(tokenOwnerAccountA ag_solanago.PublicKey) *SwapInstruction {
	inst.AccountMetaSlice[3] = ag_solanago.Meta(tokenOwnerAccountA)
	return inst
}

// GetTokenOwnerAccountAAccount gets the "tokenOwnerAccountA" account.
func (inst *SwapInstruction) GetTokenOwnerAccountAAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(3)
}

// SetTokenVaultAAccount sets the "tokenVaultA" account.
func (inst *SwapInstruction) SetTokenVaultAAccount(tokenVaultA ag_solanago.PublicKey) *SwapInstruction {
	inst.AccountMetaSlice[4] = ag_solanago.Meta(tokenVaultA)
	return inst
}

// GetTokenVaultAAccount gets the "tokenVaultA" account.
func (inst *SwapInstruction) GetTokenVaultAAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(4)
}

// SetTokenOwnerAccountBAccount sets the "tokenOwnerAccountB" account.
func (inst *SwapInstruction) SetTokenOwnerAccountBAccount(tokenOwnerAccountB ag_solanago.PublicKey) *SwapInstruction {
	inst.AccountMetaSlice[5] = ag_solanago.Meta(tokenOwnerAccountB)
	return inst
}

// GetTokenOwnerAccountBAccount gets the "tokenOwnerAccountB" account.
func (inst *SwapInstruction) GetTokenOwnerAccountBAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(5)
}

// SetTokenVaultBAccount sets the "tokenVaultB" account.
func (inst *SwapInstruction) SetTokenVaultBAccount(tokenVaultB ag_solanago.PublicKey) *SwapInstruction {
	inst.AccountMetaSlice[6] = ag_solanago.Meta(tokenVaultB)
	return inst
}

// GetTokenVaultBAccount gets the "tokenVaultB" account.
func (inst *SwapInstruction) GetTokenVaultBAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(6)
}

// SetTickArray0Account sets the "tickArray0" account.
func (inst *SwapInstruction) SetTickArray0Account(tickArray0 ag_solanago.PublicKey) *SwapInstruction {
	inst.AccountMetaSlice[7] = ag_solanago.Meta(tickArray0)
	return inst
}

// GetTickArray0Account gets the "tickArray0" account.
func (inst *SwapInstruction) GetTickArray0Account() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(7)
}

// SetTickArray1Account sets the "tickArray1" account.
func (inst *SwapInstruction) SetTickArray1Account(tickArray1 ag_solanago.PublicKey) *SwapInstruction {
	inst.AccountMetaSlice[8] = ag_solanago.Meta(tickArray1)
	return inst
}

// GetTickArray1Account gets the "tickArray1" account.
func (inst *SwapInstruction) GetTickArray1Account() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(8)
}

// SetTickArray2Account sets the "tickArray2" account.
func (inst *SwapInstruction) SetTickArray2Account(tickArray2 ag_solanago.PublicKey) *SwapInstruction {
	inst.AccountMetaSlice[9] = ag_solanago.Meta(tickArray2)
	return inst
}

// GetTickArray2Account gets the "tickArray2" account.
func (inst *SwapInstruction) GetTickArray2Account() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(9)
}

// SetOracleAccount sets the "oracle" account.
func (inst *SwapInstruction) SetOracleAccount(oracle ag_solanago.PublicKey) *SwapInstruction {
	inst.AccountMetaSlice[10] = ag_solanago.Meta(oracle)
	return inst
}

// GetOracleAccount gets the "oracle" account.
func (inst *SwapInstruction) GetOracleAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(10)
}

func (inst SwapInstruction) Build() *Instruction {
...
func (inst SwapInstruction) ValidateAndBuild() (*Instruction, error) {
...
func (inst *SwapInstruction) EncodeToTree(parent ag_treeout.Branches) {
...
func (obj SwapInstruction) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
...
func (obj *SwapInstruction) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Deserialize `Amount`:
...
func NewSwapInstruction(
	...
	oracle ag_solanago.PublicKey) *SwapInstruction {
