...
// NewSetFeeRateInstructionBuilder creates a new `SetFeeRateInstruction` instruction builder.
func NewSetFeeRateInstructionBuilder() *SetFeeRateInstruction {
	nd := &SetFeeRateInstruction{
...
func (inst *SetFeeRateInstruction) SetFeeRate(feeRate uint16) *SetFeeRateInstruction {
	inst.FeeRate = &feeRate
	return inst
}

// SetWhirlpoolsConfigAccount sets the "whirlpoolsConfig" account.
func (inst *SetFeeRateInstruction) SetWhirlpoolsConfigAccount(whirlpoolsConfig ag_solanago.PublicKey) *SetFeeRateInstruction {
	inst.AccountMetaSlice[0] = ag_solanago.Meta(whirlpoolsConfig)
	return inst
}

// GetWhirlpoolsConfigAccount gets the "whirlpoolsConfig" account.
func (inst *SetFeeRateInstruction) GetWhirlpoolsConfigAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetWhirlpoolAccount sets the "whirlpool" account.
func (inst *SetFeeRateInstruction) SetWhirlpoolAccount(whirlpool ag_solanago.PublicKey) *SetFeeRateInstruction {
	inst.AccountMetaSlice[1] = ag_solanago.Meta(whirlpool)
	return inst
}

// GetWhirlpoolAccount gets the "whirlpool" account.
func (inst *SetFeeRateInstruction) GetWhirlpoolAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(1)
}

// SetFeeAuthorityAccount sets the "feeAuthority" account.
func (inst *SetFeeRateInstruction) SetFeeAuthorityAccount(feeAuthority ag_solanago.PublicKey) *SetFeeRateInstruction {
	inst.AccountMetaSlice[2] = ag_solanago.Meta(feeAuthority)
	return inst
}

// GetFeeAuthorityAccount gets the "feeAuthority" account.
func (inst *SetFeeRateInstruction) GetFeeAuthorityAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(2)
}

func (inst SetFeeRateInstruction) Build() *Instruction {
...
func (inst SetFeeRateInstruction) ValidateAndBuild() (*Instruction, error) {
...
func (inst *SetFeeRateInstruction) Validate() error {
...
func (inst *SetFeeRateInstruction) EncodeToTree(parent ag_treeout.Branches) {
...
func (obj SetFeeRateInstruction) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
...
func (obj *SetFeeRateInstruction) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Deserialize `FeeRate`:
...
func NewSetFeeRateInstruction(
	...
	feeAuthority ag_solanago.PublicKey) *SetFeeRateInstruction {
