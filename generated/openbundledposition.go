...
// NewOpenBundledPositionInstructionBuilder creates a new `OpenBundledPositionInstruction` instruction builder.
func NewOpenBundledPositionInstructionBuilder() *OpenBundledPositionInstruction {
	nd := &OpenBundledPositionInstruction{
...
func (inst *OpenBundledPositionInstruction) SetBundleIndex(bundleIndex uint16) *OpenBundledPositionInstruction {
	inst.BundleIndex = &bundleIndex
	return inst
}

// SetTickLowerIndex sets the "tickLowerIndex" parameter.
func (inst *OpenBundledPositionInstruction) SetTickLowerIndex(tickLowerIndex int32) *OpenBundledPositionInstruction {
	inst.TickLowerIndex = &tickLowerIndex
	return inst
}

// SetTickUpperIndex sets the "tickUpperIndex" parameter.
func (inst *OpenBundledPositionInstruction) SetTickUpperIndex(tickUpperIndex int32) *OpenBundledPositionInstruction {
	inst.TickUpperIndex = &tickUpperIndex
	return inst
}

// SetBundledPositionAccount sets the "bundledPosition" account.
func (inst *OpenBundledPositionInstruction) SetBundledPositionAccount(bundledPosition ag_solanago.PublicKey) *OpenBundledPositionInstruction {
	inst.AccountMetaSlice[0] = ag_solanago.Meta(bundledPosition)
	return inst
}

// GetBundledPositionAccount gets the "bundledPosition" account.
func (inst *OpenBundledPositionInstruction) GetBundledPositionAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetPositionBundleAccount sets the "positionBundle" account.
func (inst *OpenBundledPositionInstruction) SetPositionBundleAccount(positionBundle ag_solanago.PublicKey) *OpenBundledPositionInstruction {
	inst.AccountMetaSlice[1] = ag_solanago.Meta(positionBundle)
	return inst
}

// GetPositionBundleAccount gets the "positionBundle" account.
func (inst *OpenBundledPositionInstruction) GetPositionBundleAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(1)
}

// SetPositionBundleTokenAccountAccount sets the "positionBundleTokenAccount" account.
func (inst *OpenBundledPositionInstruction) SetPositionBundleTokenAccountAccount(positionBundleTokenAccount ag_solanago.PublicKey) *OpenBundledPositionInstruction {
...
func (inst *OpenBundledPositionInstruction) GetPositionBundleTokenAccountAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(2)
}

// SetPositionBundleAuthorityAccount sets the "positionBundleAuthority" account.
func (inst *OpenBundledPositionInstruction) SetPositionBundleAuthorityAccount(positionBundleAuthority ag_solanago.PublicKey) *OpenBundledPositionInstruction {
...
func (inst *OpenBundledPositionInstruction) GetPositionBundleAuthorityAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(3)
}

// SetWhirlpoolAccount sets the "whirlpool" account.
func (inst *OpenBundledPositionInstruction) SetWhirlpoolAccount(whirlpool ag_solanago.PublicKey) *OpenBundledPositionInstruction {
	inst.AccountMetaSlice[4] = ag_solanago.Meta(whirlpool)
	return inst
}

// GetWhirlpoolAccount gets the "whirlpool" account.
func (inst *OpenBundledPositionInstruction) GetWhirlpoolAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(4)
}

// SetFunderAccount sets the "funder" account.
func (inst *OpenBundledPositionInstruction) SetFunderAccount(funder ag_solanago.PublicKey) *OpenBundledPositionInstruction {
	inst.AccountMetaSlice[5] = ag_solanago.Meta(funder)
	return inst
}

// GetFunderAccount gets the "funder" account.
func (inst *OpenBundledPositionInstruction) GetFunderAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(5)
}

// SetSystemProgramAccount sets the "systemProgram" account.
func (inst *OpenBundledPositionInstruction) SetSystemProgramAccount(systemProgram ag_solanago.PublicKey) *OpenBundledPositionInstruction {
	inst.AccountMetaSlice[6] = ag_solanago.Meta(systemProgram)
	return inst
}

// GetSystemProgramAccount gets the "systemProgram" account.
func (inst *OpenBundledPositionInstruction) GetSystemProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(6)
}

// SetRentAccount sets the "rent" account.
func (inst *OpenBundledPositionInstruction) SetRentAccount(rent ag_solanago.PublicKey) *OpenBundledPositionInstruction {
	inst.AccountMetaSlice[7] = ag_solanago.Meta(rent)
	return inst
}

// GetRentAccount gets the "rent" account.
func (inst *OpenBundledPositionInstruction) GetRentAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(7)
}

func (inst OpenBundledPositionInstruction) Build() *Instruction {
...
func (inst OpenBundledPositionInstruction) ValidateAndBuild() (*Instruction, error) {
...
func (inst *OpenBundledPositionInstruction) Validate() error {
...
func (inst *OpenBundledPositionInstruction) EncodeToTree(parent ag_treeout.Branches) {
...
func (obj OpenBundledPositionInstruction) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
...
func (obj *OpenBundledPositionInstruction) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
...
func NewOpenBundledPositionInstruction(
	...
	rent ag_solanago.PublicKey) *OpenBundledPositionInstruction {
