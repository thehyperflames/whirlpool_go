...
// NewOpenPositionInstructionBuilder creates a new `OpenPositionInstruction` instruction builder.
func NewOpenPositionInstructionBuilder() *OpenPositionInstruction {
	nd := &OpenPositionInstruction{
...
func (inst *OpenPositionInstruction) SetBumps(bumps OpenPositionBumps) *OpenPositionInstruction {
	inst.Bumps = &bumps
	return inst
}

// SetTickLowerIndex sets the "tickLowerIndex" parameter.
func (inst *OpenPositionInstruction) SetTickLowerIndex(tickLowerIndex int32) *OpenPositionInstruction {
	inst.TickLowerIndex = &tickLowerIndex
	return inst
}

// SetTickUpperIndex sets the "tickUpperIndex" parameter.
func (inst *OpenPositionInstruction) SetTickUpperIndex(tickUpperIndex int32) *OpenPositionInstruction {
	inst.TickUpperIndex = &tickUpperIndex
	return inst
}

// SetFunderAccount sets the "funder" account.
func (inst *OpenPositionInstruction) SetFunderAccount(funder ag_solanago.PublicKey) *OpenPositionInstruction {
	inst.AccountMetaSlice[0] = ag_solanago.Meta(funder)
	return inst
}

// GetFunderAccount gets the "funder" account.
func (inst *OpenPositionInstruction) GetFunderAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetOwnerAccount sets the "owner" account.
func (inst *OpenPositionInstruction) SetOwnerAccount(owner ag_solanago.PublicKey) *OpenPositionInstruction {
	inst.AccountMetaSlice[1] = ag_solanago.Meta(owner)
	return inst
}

// GetOwnerAccount gets the "owner" account.
func (inst *OpenPositionInstruction) GetOwnerAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(1)
}

// SetPositionAccount sets the "position" account.
func (inst *OpenPositionInstruction) SetPositionAccount(position ag_solanago.PublicKey) *OpenPositionInstruction {
	inst.AccountMetaSlice[2] = ag_solanago.Meta(position)
	return inst
}

// GetPositionAccount gets the "position" account.
func (inst *OpenPositionInstruction) GetPositionAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(2)
}

// SetPositionMintAccount sets the "positionMint" account.
func (inst *OpenPositionInstruction) SetPositionMintAccount(positionMint ag_solanago.PublicKey) *OpenPositionInstruction {
	inst.AccountMetaSlice[3] = ag_solanago.Meta(positionMint)
	return inst
}

// GetPositionMintAccount gets the "positionMint" account.
func (inst *OpenPositionInstruction) GetPositionMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(3)
}

// SetPositionTokenAccountAccount sets the "positionTokenAccount" account.
func (inst *OpenPositionInstruction) SetPositionTokenAccountAccount(positionTokenAccount ag_solanago.PublicKey) *OpenPositionInstruction {
...
func (inst *OpenPositionInstruction) GetPositionTokenAccountAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(4)
}

// SetWhirlpoolAccount sets the "whirlpool" account.
func (inst *OpenPositionInstruction) SetWhirlpoolAccount(whirlpool ag_solanago.PublicKey) *OpenPositionInstruction {
	inst.AccountMetaSlice[5] = ag_solanago.Meta(whirlpool)
	return inst
}

// GetWhirlpoolAccount gets the "whirlpool" account.
func (inst *OpenPositionInstruction) GetWhirlpoolAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(5)
}

// SetTokenProgramAccount sets the "tokenProgram" account.
func (inst *OpenPositionInstruction) SetTokenProgramAccount(tokenProgram ag_solanago.PublicKey) *OpenPositionInstruction {
	inst.AccountMetaSlice[6] = ag_solanago.Meta(tokenProgram)
	return inst
}

// GetTokenProgramAccount gets the "tokenProgram" account.
func (inst *OpenPositionInstruction) GetTokenProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(6)
}

// SetSystemProgramAccount sets the "systemProgram" account.
func (inst *OpenPositionInstruction) SetSystemProgramAccount(systemProgram ag_solanago.PublicKey) *OpenPositionInstruction {
	inst.AccountMetaSlice[7] = ag_solanago.Meta(systemProgram)
	return inst
}

// GetSystemProgramAccount gets the "systemProgram" account.
func (inst *OpenPositionInstruction) GetSystemProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(7)
}

// SetRentAccount sets the "rent" account.
func (inst *OpenPositionInstruction) SetRentAccount(rent ag_solanago.PublicKey) *OpenPositionInstruction {
	inst.AccountMetaSlice[8] = ag_solanago.Meta(rent)
	return inst
}

// GetRentAccount gets the "rent" account.
func (inst *OpenPositionInstruction) GetRentAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(8)
}

// SetAssociatedTokenProgramAccount sets the "associatedTokenProgram" account.
func (inst *OpenPositionInstruction) SetAssociatedTokenProgramAccount(associatedTokenProgram ag_solanago.PublicKey) *OpenPositionInstruction {
	inst.AccountMetaSlice[9] = ag_solanago.Meta(associatedTokenProgram)
	return inst
}

// GetAssociatedTokenProgramAccount gets the "associatedTokenProgram" account.
func (inst *OpenPositionInstruction) GetAssociatedTokenProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(9)
}

func (inst OpenPositionInstruction) Build() *Instruction {
...
func (inst OpenPositionInstruction) ValidateAndBuild() (*Instruction, error) {
...
func (inst *OpenPositionInstruction) Validate() error {
...
func (inst *OpenPositionInstruction) EncodeToTree(parent ag_treeout.Branches) {
...
func (obj OpenPositionInstruction) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
...
func (obj *OpenPositionInstruction) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Deserialize `Bumps`:
...
func NewOpenPositionInstruction(
	...
	associatedTokenProgram ag_solanago.PublicKey) *OpenPositionInstruction {
