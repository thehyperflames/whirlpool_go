...
func (inst *InitializePoolInstruction) SetBumps(bumps WhirlpoolBumps) *InitializePoolInstruction {
	inst.Bumps = &bumps
	return inst
}

// SetTickSpacing sets the "tickSpacing" parameter.
func (inst *InitializePoolInstruction) SetTickSpacing(tickSpacing uint16) *InitializePoolInstruction {
	inst.TickSpacing = &tickSpacing
	return inst
}

// SetInitialSqrtPrice sets the "initialSqrtPrice" parameter.
func (inst *InitializePoolInstruction) SetInitialSqrtPrice(initialSqrtPrice ag_binary.Uint128) *InitializePoolInstruction {
	inst.InitialSqrtPrice = &initialSqrtPrice
	return inst
}

// SetWhirlpoolsConfigAccount sets the "whirlpoolsConfig" account.
func (inst *InitializePoolInstruction) SetWhirlpoolsConfigAccount(whirlpoolsConfig ag_solanago.PublicKey) *InitializePoolInstruction {
	inst.AccountMetaSlice[0] = ag_solanago.Meta(whirlpoolsConfig)
	return inst
}

// GetWhirlpoolsConfigAccount gets the "whirlpoolsConfig" account.
func (inst *InitializePoolInstruction) GetWhirlpoolsConfigAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetTokenMintAAccount sets the "tokenMintA" account.
func (inst *InitializePoolInstruction) SetTokenMintAAccount(tokenMintA ag_solanago.PublicKey) *InitializePoolInstruction {
	inst.AccountMetaSlice[1] = ag_solanago.Meta(tokenMintA)
	return inst
}

// GetTokenMintAAccount gets the "tokenMintA" account.
func (inst *InitializePoolInstruction) GetTokenMintAAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(1)
}

// SetTokenMintBAccount sets the "tokenMintB" account.
func (inst *InitializePoolInstruction) SetTokenMintBAccount(tokenMintB ag_solanago.PublicKey) *InitializePoolInstruction {
	inst.AccountMetaSlice[2] = ag_solanago.Meta(tokenMintB)
	return inst
}

// GetTokenMintBAccount gets the "tokenMintB" account.
func (inst *InitializePoolInstruction) GetTokenMintBAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(2)
}

// SetFunderAccount sets the "funder" account.
func (inst *InitializePoolInstruction) SetFunderAccount(funder ag_solanago.PublicKey) *InitializePoolInstruction {
	inst.AccountMetaSlice[3] = ag_solanago.Meta(funder)
	return inst
}

// GetFunderAccount gets the "funder" account.
func (inst *InitializePoolInstruction) GetFunderAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(3)
}

// SetWhirlpoolAccount sets the "whirlpool" account.
func (inst *InitializePoolInstruction) SetWhirlpoolAccount(whirlpool ag_solanago.PublicKey) *InitializePoolInstruction {
	inst.AccountMetaSlice[4] = ag_solanago.Meta(whirlpool)
	return inst
}

// GetWhirlpoolAccount gets the "whirlpool" account.
func (inst *InitializePoolInstruction) GetWhirlpoolAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(4)
}

// SetTokenVaultAAccount sets the "tokenVaultA" account.
func (inst *InitializePoolInstruction) SetTokenVaultAAccount(tokenVaultA ag_solanago.PublicKey) *InitializePoolInstruction {
	inst.AccountMetaSlice[5] = ag_solanago.Meta(tokenVaultA)
	return inst
}

// GetTokenVaultAAccount gets the "tokenVaultA" account.
func (inst *InitializePoolInstruction) GetTokenVaultAAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(5)
}

// SetTokenVaultBAccount sets the "tokenVaultB" account.
func (inst *InitializePoolInstruction) SetTokenVaultBAccount(tokenVaultB ag_solanago.PublicKey) *InitializePoolInstruction {
	inst.AccountMetaSlice[6] = ag_solanago.Meta(tokenVaultB)
	return inst
}

// GetTokenVaultBAccount gets the "tokenVaultB" account.
func (inst *InitializePoolInstruction) GetTokenVaultBAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(6)
}

// SetFeeTierAccount sets the "feeTier" account.
func (inst *InitializePoolInstruction) SetFeeTierAccount(feeTier ag_solanago.PublicKey) *InitializePoolInstruction {
	inst.AccountMetaSlice[7] = ag_solanago.Meta(feeTier)
	return inst
}

// GetFeeTierAccount gets the "feeTier" account.
func (inst *InitializePoolInstruction) GetFeeTierAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(7)
}

// SetTokenProgramAccount sets the "tokenProgram" account.
func (inst *InitializePoolInstruction) SetTokenProgramAccount(tokenProgram ag_solanago.PublicKey) *InitializePoolInstruction {
	inst.AccountMetaSlice[8] = ag_solanago.Meta(tokenProgram)
	return inst
}

// GetTokenProgramAccount gets the "tokenProgram" account.
func (inst *InitializePoolInstruction) GetTokenProgramAccount() *ag_solanago.AccountMeta {
...
func (inst *InitializePoolInstruction) SetRentAccount(rent ag_solanago.PublicKey) *InitializePoolInstruction {
	inst.AccountMetaSlice[10] = ag_solanago.Meta(rent)
	return inst
}

// GetRentAccount gets the "rent" account.
func (inst *InitializePoolInstruction) GetRentAccount() *ag_solanago.AccountMeta {
...
func NewInitializePoolInstruction(
	...
	rent ag_solanago.PublicKey) *InitializePoolInstruction {
